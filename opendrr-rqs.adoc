...
[#_Ref4082640]
image::extracted-media/media/image3.png[width=501,height=513,title="‘The Global Risk Landscape 2019’ Impact- Likelihood of risk perception graph. People are becoming more aware of the environmental changes and the related risks. Red dashed circle highlights the environmental risks. (Modified form World Economic Forum 2019)"]
...
[#_Ref4082544]
image::extracted-media/media/image4.png[width=624,height=270,title="The component for assessing risk. A) Hazard- the natural system component of risk. B) Exposure – the human component of risk. (Modified from World Bank 2014)"]
...
[#_Ref4158628]
image::extracted-media/media/image5.png[width=588,height=765,title="INSPIRE Natural Risk Zone UML diagram https://inspire.ec.europa.eu/data-model/approved/r4618-ir/html/index.htm?goto=2:3:12:1:8552"]
...
[#_Toc4416656]
image::extracted-media/media/image6.png[https://inspire.ec.europa.eu/data-model/approved/r4618-ir/html/EARoot/EA2/EA3/EA2/EA2/EA7912.png,width=555,height=519,title="The INSPIRE Building UML diagram (https://inspire.ec.europa.eu/data-model/approved/r4618-ir/html/index.htm?goto=2:3:2:2:7911)"]
...
[#_Ref4162595]
image::extracted-media/media/image7.png[width=604,height=526,title="From OpenQuake to OpenDRR and end users (M. Journeay, personal communication)"]
...
[#_Ref4162630]
image::extracted-media/media/image8a.png[width=500,title="Steps for an ontology creation. (Noy & McGuinness, 2001)"]
...
[#_Ref4161660]
image::extracted-media/media/image8.png[width=415,height=457,title="OpenDRR risk metrics table summary (M. Journeay, personal communication)"]
...
[#_Ref4161782]
image::extracted-media/media/image9.png[width=527,height=203,title="OpenDRR taxonomy table summary (M. Journeay, personal communication)"]
...
[#_Ref4082180]
image::extracted-media/media/image10.jpg[width=598,height=413,title="OpenDRR (red squares) in the context of the Federal Geospatial Platform (FGP) (Natural Resources Canada, 2015)"]
...
[#_Ref4397587]
image::extracted-media/media/image11.png[width=624,height=427,title="British Columbia Earthquake Risk Portal - Example of Earthquake Risk Reporting Tool"]
...
[#_Ref4397657]
image::extracted-media/media/image12.jpeg[width=377,height=203,title="Generic Framework of RiskScape for risk assessment tools in OpenDRR (https://wiki.riskscape.org.nz/[https://wiki.riskscape.org.nz)"]
...
[#_Ref4079638]
image::extracted-media/media/image13.png[width=529,height=544,title="OpenDRR Integration and Delivery of Information within Federal Geospatial Platform. (Natural Resources Canada, 2015)"]

[#_Ref4398603]
image::extracted-media/media/image13a.png[width=500,title="User-Centric Approach to Open, Decision Support Systems"]
...
[#_Ref4404024]
image::extracted-media/media/image24.png[Image result for standard cartoon,width=500,height=283,title="The importance of definition of standards. (https://xkcd.com/927/)"]
...
[#_Ref4399720]
image::extracted-media/media/image25.png[width=559,height=759,title="Metrics for Risk assessment. Boxes with letter-number prefixes are from the Sendai Framework. Other metrics are specific to the OpenDRR"]
...
[#_Ref4400577]
image::extracted-media/media/image26.png[width=518,height=610,title="Natural Risk Zone Application schema http://inspire-regadmin.jrc.ec.europa.eu/dataspecification/ScopeObjectPreselection.action"]

[#_Ref4400874]
image::extracted-media/media/image27.png[width=624,height=260,title="Radial graph view of Natural Hazard Category Value code list http://inspire-regadmin.jrc.ec.europa.eu/dataspecification/ScopeObjectDetail.action?objectDetailId=10621"]
...
[#_Ref4400514]
image::extracted-media/media/image28.png[width=624,height=480,title="Factors of social vulnerability after (Cutter, Boruff, & Shirley, 2003)"]
...
[#_Toc4416671]
image::extracted-media/media/image29.png[image,width=624,height=684,title="Extract of MOVER vulnerability schema"]
